...
export const HeaderNavbarWithPngPictures = () => {
  return (
    <section className={classes.navBarWithPngPicturesWrapper}>
      <HeaderNavbarWithPngPicturesItem content={Links.ACCOUNT} />
      <HeaderNavbarWithPngPicturesItem content={Links.CART} />
    </section>
  );
};
