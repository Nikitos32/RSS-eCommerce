...
export const ProductPreviewItem = ({
  ...
  return (
    <div className=" h-[43.75rem] transition duration-700 ease-in-out bg-slate-300 max-w-72 m-auto rounded p-3 flex flex-col justify-between hover:shadow-[1px_1px_8px]">
      <div>
        <img
          loading="lazy"
          src={imgUrl}
        ...
        <div className="flex flex-col w-auto gap-5 pt-3">
          <p className="text-gray-500 h-[4.5rem]">{productCategory}</p>
